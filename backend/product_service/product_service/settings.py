...
SECRET_KEY = 'tt$87+a90z4n_1r$rnrh&07xav1v1rpnte61s16#3c3$3!3i)f'
...
connect(
    db="product_db",  # Your MongoDB database name
    host="mongodb://localhost:27017/product_db",  # MongoDB connection URI
    alias="default"
)
